...
namespace CarManagerWindowsFormsUI {
	...
	/// </summary>
	public ref class CreateCarForm : public System::Windows::Forms::Form
	{
	public:
		CreateCarForm(CarService^ service)
		{
			InitializeComponent();
			//
			CustomInitialize();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SubmitButton->Click += gcnew System::EventHandler(this, &CreateCarForm::SubmitButton_Click);
			// 
			...
			this->Name = L"CreateCarForm";
			this->Text = L"CreateCarForm";
